...
<div class="container" style="margin-top:50px;">
	<div class="row">
 		<div class="formWrapper center-block" style="width:400px; height:300px; background-color:#D8D8D8; border-radius:10px;">
            ...
            <form name="frmLogin" class="form-horizontal" action="login" method="post" onsubmit= "check();" >
            	<div class="box-body">
					<div class="input-group" style="margin-bottom: 25px">
    					...
    					<i class="glyphicon glyphicon-user"></i>
  				   		...
  				   		<input id="login-id" type="text" class="form-control" name="id" placeholder="Input ID">                                        
			    	</div>
               		<div class="input-group" style="margin-bottom: 25px">
                		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
    					<span class="input-group-addon">
    					<i class="glyphicon glyphicon-lock"></i>
  				    	...
  				    	<input id="login-password" type="text" class="form-control" name="password" placeholder="Input Password">                                        
			    	</div>
                  	<br>
